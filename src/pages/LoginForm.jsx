    ...
    return(
        <div className="min-h-screen bg-white flex items-center justify-center p-4">
            <div className="bg-green-500/90 backdrop-blur-md border border-green-400/30 rounded-2xl p-8 w-full max-w-md shadow-2xl">
                ...
                <h2 className="text-3xl font-semibold text-white text-center mb-8 drop-shadow-lg">Sign in</h2>
                
                <div className="space-y-6">
                    <div>
                        <div className="text-white text-sm font-bold mb-2 drop-shadow text-left">Email</div>
                        <input 
                            type="email" 
                    ...
                    <div>
                        <div className=" text-white text-sm text-left font-semibold mb-2 drop-shadow">Password</div>
                        <input 
                            type="password" 
                    ...
                    <div className="flex items-center justify-between text-sm">
                        <div className="flex items-center text-white drop-shadow">
                            <input type="checkbox" className="mr-2 rounded accent-yellow-400" />
                            Remember me
                        </div>
                        <a href="#" className="text-white hover:text-yellow-300 transition-colors duration-200 drop-shadow">
                            Forgot password?
                        </a>
                    </div>
                    ...
                    <div className="text-center">
                        <a href="#" className="text-white hover:text-yellow-300 text-sm transition-colors duration-200 drop-shadow">
